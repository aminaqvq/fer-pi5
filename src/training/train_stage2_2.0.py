...
from dataset import get_dataloaders_hybrid, FER2013Hybrid, IMG_SIZE  # 导入 FER2013Hybrid 类
...
CFG: Dict[str, object] = dict(
    ...
    pseudo_csv=r"D:\fer-pi5\data\csv\pseudo_labeled_stage2.csv",  # generate_pseudo_stage2.py 生成的伪标签文件
...
# 创建 DataLoader 的函数
# -------------------------
def _make_loader(ds, batch_size, shuffle, cfg):
    kwargs = dict(
